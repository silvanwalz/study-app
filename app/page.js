...
function getProgress(step, phase, interactionIndex) {
  // Total steps: welcome(1) + pre-q(1) + 6x(scenario+bot+questionnaire=3) + ranking(1) + final-q(1) + debrief(1) = 23
  if (step === "welcome") return 0;
  if (step === "pre-q") return 4;
  if (step === "interaction") {
    var base = 8 + interactionIndex * 13; // each interaction is ~13% of total
          ...
          <PreQuestionnaire
            onSubmit={function (data) {
              ...
              saveToSheets("demographics", participantId, group, [
                data.timestamp, participantId, group,
              ...
              saveToSheets("tpa_baseline", participantId, group, [
                ...
                data.tpaBaseline["TPA-7"], data.tpaBaseline["TPA-8"],
                data.tpaBaseline["TPA-9"], data.tpaBaseline["TPA-10"],
                data.tpaBaseline["TPA-11"], data.tpaBaseline["TPA-12"],
          ...
          <TrustQuestionnaire
            ...
            onSubmit={function (data) {
              ...
              saveToSheets("post_interaction", participantId, group, [
                ...
                data.trustScore, data.distrustScore,
              ]);
              nextStep();
            }}
          />
          ...
          <FinalQuestionnaire
            onSubmit={function (data) {
              ...
              saveToSheets("tpa_post", participantId, group, [
                ...
                data.tpaPost["TPA-POST-7"], data.tpaPost["TPA-POST-8"],
                data.tpaPost["TPA-POST-9"], data.tpaPost["TPA-POST-10"],
                data.tpaPost["TPA-POST-11"], data.tpaPost["TPA-POST-12"],
